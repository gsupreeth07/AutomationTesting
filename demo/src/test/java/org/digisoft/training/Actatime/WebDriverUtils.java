...
public class WebDriverUtils {
	...
	static {
		...
		String drivers[] = {"chromedriver",  "edgedriver"};
		try {
	...
	public List<WebElement> Elements(String identifiers, String values) {
		System.out.println("finding Element using " + identifiers + " and " + values);
		List<WebElement> eles = null;
		switch (identifiers.toLowerCase()) {
		case "id":
			eles = driver.findElements(By.id(values));
			break;

		case "name":
			eles = driver.findElements(By.name(values));
			break;

		case "classname":
			eles = driver.findElements(By.className(values));
			break;

		case "tagname":
			eles = driver.findElements(By.tagName(values));
			break;

		case "linktext":
			eles = driver.findElements(By.linkText(values));
			break;

		case "partiallinktext":
			eles = driver.findElements(By.partialLinkText(values));
			break;

		case "css":
			eles = driver.findElements(By.cssSelector(values));
			break;

		case "xpath":
			eles = driver.findElements(By.xpath(values));
			break;
